...
class StorageOwnerController extends Controller
{
    public function index()
    {
        return view('storage_owner.dashboard');
    }
    public function sendChat(Request $request)
    {
        ...
        $chat->save();
        return redirect()->route('storage_owner.chats', ['chat_id' => $chat->id]);
    }
    public function getChats(Request $request)
    {
        ...
        return view('storage_owner.chat', compact('chats', 'selectedChat'));
    }
}
