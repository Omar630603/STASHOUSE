        ...
        <div class="max-w-7xl py-3 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 container mx-auto">
                ...
                <div class="min-w-full mt-5 rounded lg:grid lg:grid-cols-3">
                    {{-- side-bar --}}
                    <div class="unitlist lg:col-span-1">
                        ...
                        <div class="w-full lg:ml-3 rounded-xl border-2">
                            ...
                            <div class="px-5 py-6">
                                ...
                                <div class="my-5">
                                    ...
                                    @foreach ($selectedUnit->rents->sortBy('starts_from')->groupBy('status',
                                    'starts_from',
                                    'ends_at') as
                                    $unitRents)
                                    @php
                ...
                <div class="mb-4">
                    <span class="flex gap-3 text-xl font-bold text-black">Ulasan
                        ...
                        <div class="flex items-center">
                            @for ($i = 0; $i < $avgRating; $i++) <svg aria-hidden="true" class="w-5 h-5 text-yellow-400"
                                ...
                                @for ($i = 0; $i < 5 - $avgRating; $i++) <svg aria-hidden="true"
                                    class="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if($selectedUnit->reviews->count() > 0) <div class="my-4 max-h-[15rem] overflow-auto">
                        ...
                        <div class="flex gap-2 border-b-2 rounded py-2 mb-1">
                            <img class="object-fit w-8 h-8 rounded-full ml-2"
                                src="{{ asset('storage/'. $review->customer->image) }}" alt="ownerImage" />
                            <div class="flex flex-col ml-2">
                                <span class="text-base text-black font-bold">{{$review->customer->user->name}}</span>
                    ...
                    <div class="mt-6 border-2 border-gray p-2 rounded-xl">
                        <div class="flex flex-col">
                            <form action="{{ route('customer.review', ['unit'=>$selectedUnit]) }}" method="POST">
                                @csrf
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm text-black">
                                        <label for="message" class="text-right block text-sm font-medium text-gray-900">
                                            Rating Anda</label>
                                        <div class="rating">
                                            <label>
                ...
                <div>
                    ...
                    <div id="controls-carousel" class="relative mt-5" data-carousel="static">
                        <div id="carouselOffsett" class="overflow-hidden crelative h-48 rounded-lg md:h-56">
                            @foreach ($selectedUnit->assets as $key => $asset)
                            <div class="duration-700 ease-in-out w-1/3" data-carousel-item{{$key==0 ? '="active"' : ''
                                }}>
                        ...
                        <button type="button"
                            ...
                            <span
                                ...
                                <svg aria-hidden="true" class="w-6 h-6 text-white" fill="none" stroke="#3F1652"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 19l-7-7 7-7">
                                    </path>
                ...
                <form class="mt-8" method="POST" action="{{ route('customer.sendChat') }}">
                    @csrf
                    <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only">Hubungi
                        Penjual</label>
                    <div class="relative">
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                                        <use xlink:href="#image0_942_284" transform="scale(0.0416667)" />
                                    </pattern>
