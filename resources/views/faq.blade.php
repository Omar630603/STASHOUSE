<x-guest-layout>
    ...
    <section class="bg-white">
        <div class="container px-6 py-12 mx-auto">
            <h1 class="text-2xl font-semibold text-center text-gray-800 lg:text-4xl">Have any Questions?
            </h1>
            ...
            <div class="mt-8 xl:mt-16 lg:flex lg:-mx-12">
                <div class="lg:mx-12">
                    ...
                    <div class="tabs-menu mt-4 space-y-4 lg:mt-8">
                        <a href="#tab-1" class="block text-blue-500 hover:underline">General</a>
                        <a href="#tab-2" class="block text-gray-500 hover:underline">Trust &
                            Safety</a>
                        <a href="#tab-3" class="block text-gray-500 hover:underline">Services</a>
                        <a href="#tab-4" class="block text-gray-500 hover:underline">Billing</a>
                        <a href="#tab-5" class="block text-gray-500 hover:underline">Office
                            Cleaning</a>
                    </div>
                </div>

                <div id="tab-1" class=" tab-content flex-1 mt-8 lg:mx-12 lg:mt-0">
                    <div>
                        <button onclick="openClose(this)" class="flex items-center focus:outline-none">
                            ...
                            <h1 class="mx-4 text-xl text-gray-700">How i can play for my appoinment ?
                            </h1>
                        </button>
                ...
                <div id="tab-2" class="hidden tab-content flex-1 mt-8 lg:mx-12 lg:mt-0">
                    <div>
                        <button onclick="openClose(this)" class="flex items-center focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-500" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="tab-3" class="hidden tab-content flex-1 mt-8 lg:mx-12 lg:mt-0">
                    <div>
                        <button onclick="openClose(this)" class="flex items-center focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-500" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="tab-4" class="hidden tab-content flex-1 mt-8 lg:mx-12 lg:mt-0">
                    <div>
                        <button onclick="openClose(this)" class="flex items-center focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-500" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="tab-5" class="hidden tab-content flex-1 mt-8 lg:mx-12 lg:mt-0">
                    <div>
                        <button onclick="openClose(this)" class="flex items-center focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-500" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
