                ...
                <div class="chats border-r border-gray-300 lg:col-span-1">
                    ...
                    <ul id="chatList" class="overflow-auto h-fit mb-3 max-h-[40rem]">
                        ...
                        <li class="p-2 border-2 border-[#E7E7E7] rounded-xl mb-3 mx-3">
                            @endif
                            <a href="{{ route('storage_owner.chats', ['chat_id'=>$chat->id]) }}" class="flex items-center p-6 text-sm transition duration-150 
                    ...
                    <div class="w-full">
                        ...
                        <div>
                            <form method="POST" enctype="multipart/form-data"
                                ...
                                action="{{ route('storage_owner.sendChat', ['chat_id', $selectedChat->id]) }}">
                                @csrf
