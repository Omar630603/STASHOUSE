        ...
        <div class="bg-gray-100 rounder-lg my-4">
            <div class="container flex items-center px-6 py-4 mx-auto overflow-y-auto whitespace-nowrap">
                ...
                <a href="" class="flex items-center text-blue-600 -px-2 hover:underline">
                    ...
                    <span class="mx-2">Chooce a City</span>
                </a>
            ...
            <div class="w-full rounded-lg border-4 border-solid border-[#72358E] p-4 relative">
                ...
                <form class="flex flex-col">
                    ...
                    <div class="flex justify-between mt-4 z-50">
                        <small class="self-center p-2 border-l-2 border-[#F8C35B] bg-[#F8C35B50] text-black">Choose a
                            city
                            where you want to rent a storage unit</small>
                        <x-button>
                            {{ __('Show me the list') }}
                        </x-button>
                    </div>
